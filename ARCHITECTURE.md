...
业务层（具体游戏）
        ↓
Runtime Services（Scheduler / Scene / Camera / Input / Audio / UI / Save / Settings / Procedure）── 对应第 4 节表格中的 Service 层
        ↓
...
└── godo_framework/       可整体复制的 GoDo 插件包
    ...
    │                      与 Service 子目录如 Scheduler/Scene/Camera/Input/Audio/UI/Save/Settings/Procedure，
