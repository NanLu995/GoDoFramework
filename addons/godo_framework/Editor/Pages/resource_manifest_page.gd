...
func setup(controller: RefCounted) -> void:
	...
	_controller.manifest_paths_changed.connect(_on_manifest_paths_changed)
	...
	refresh_button.name = "GoDoResourceManifestRefreshButton"
	...
	_validate_button.name = "GoDoResourceManifestValidateButton"
...
func dispose() -> void:
	if (
		...
		and _controller.manifest_paths_changed.is_connected(_on_manifest_paths_changed)
	):
		_controller.manifest_paths_changed.disconnect(_on_manifest_paths_changed)
...
func _on_manifest_paths_changed(preferred_path: String) -> void:
